...
def test_router_selects_anthropic_by_config() -> None:
    settings = Settings(default_provider="anthropic", anthropic_api_key="x")
...
def test_router_selects_openai_by_config() -> None:
    settings = Settings(default_provider="openai", openai_api_key="x")
    provider = select_provider(settings)
    assert provider.name == "openai"


def test_router_can_override_provider() -> None:
    settings = Settings(default_provider="anthropic", openai_api_key="x")
